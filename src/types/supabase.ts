...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      get_comment_details_with_likes: {
        Args: {
          p_post_id: string
        }
        Returns: {
      ...
      get_user_bookmarks: {
        ...
        Returns: {
          forum_bookmark_id: string[]
          forum_comment_bookmark_id: string[]
          qna_bookmark_id: string[]
          qna_comment_bookmark_id: string[]
          archive_bookmark_id: string[]
          archive_comment_bookmark_id: string[]
        }[]
      }
      get_user_likes: {
        Args: {
        ...
        Returns: {
          forum_like_id: string[]
          forum_comment_like_id: string[]
          qna_like_id: string[]
          qna_comment_like_id: string[]
          archive_like_id: string[]
          archive_comment_like_id: string[]
        }[]
      }
